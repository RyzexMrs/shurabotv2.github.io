...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Name</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "shura"}" placeholder="Nickname" maxlength="30" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Room</label>
